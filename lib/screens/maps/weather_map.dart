    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned(
            bottom: 100, // Adjust to position below the search bar
            left: 20,
            right: 20,
          ...
          Positioned(
            bottom: 160, // Position relative to the bottom
...
class HeatmapLegend extends StatelessWidget {
  ...
  const HeatmapLegend({super.key, required this.mapType});

  @override
  Widget build(BuildContext context) {
    final legendData = _getLegendData(mapType);

    if (legendData == null) return const SizedBox.shrink(); // Skip rendering for WND
      ...
      case "PAR0": // Rain
        return {
          ...
          'colors': const [
            ...
            Color(0xFF9696AA),
            Color(0xFFC89696),
            Color.fromARGB(255, 234, 228, 203),
          ],
          'stops': [140, 50, 10, 1, 0.5, 0.2, 0.1, 0],
        };

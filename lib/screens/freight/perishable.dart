...
//   @override
//   _PerishableItemsScreenState createState() => _PerishableItemsScreenState();
// }
...
//     {'name': 'Ladyfinger', 'image': 'assets/images/ladyfinger.png'},
//     {'name': 'Lemon', 'image': 'assets/images/lemon.png'},
...
//   void initState() {
//     super.initState();
//     filteredItems = items; // Start with all items showing
...
//             .toList();
//       } else {
//         filteredItems = items; // Show all items if search is cleared
//       }
//     });
//   }
...
//             hintText: 'Search Perishable Items',
...
//                   return _buildItemCard(item['name']!, item['image']!);
//                 },
//               ),
//             ),
//           ],
...
//   Widget _buildItemCard(String itemName, String imagePath) {
...
//         children: [
//           Image.asset(imagePath, height: 100), // Replace with correct image path
